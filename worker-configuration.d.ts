/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ddbf0b2666cc615d06c7a01ba677a45)
// Runtime types generated with workerd@1.20260702.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	TRACKER_ORIGIN: "https://analytics.fayazahmed.com";
	LIVE_VISITORS: DurableObjectNamespace<import("./src/server").LiveVisitors>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "LiveVisitors";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRACKER_ORIGIN">> {}
}
